          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-content">
                      <div class="card-body">
                          <div class="row">
                              <!-- <div class="col-lg-3 col-sm-12 border-right-blue-grey border-right-lighten-5 mr-5">
                                  <div class="pb-1">
                                      ...
                                      <div class="clearfix">
                                          <span class="text-muted">Template undangan</span>
                              ...
                              <div class="col-lg-3 col-sm-12 border-right-blue-grey border-right-lighten-5 mr-5">
                                  <div class="pb-1">
                                      <div class="clearfix mb-1">
                                          ...
                                          <span class="font-large-2 text-bold-300 success float-right">323</span>
                                      </div>
                                      <div class="clearfix">
                                          <span class="text-muted">Customer order</span>
                                          <span class="success float-right"><i class="ft-arrow-up success"></i> 2.24%</span>
                                      </div>
                                  </div>
                                  <div class="progress mb-0" style="height: 7px;">
